...
import { getOneRiwayatIdentifikasi } from "../../../services/identifikasi";

const RiwayatIdentifikasiDetail = ({ payload, users }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Detail Riwayat Identifikasi - Sistem Pakar Identifikasi Tanaman Kakao
...
export default RiwayatIdentifikasiDetail;
...
export async function getServerSideProps({ req, params }) {
  ...
  const response = await getOneRiwayatIdentifikasi(token, params?.id);
