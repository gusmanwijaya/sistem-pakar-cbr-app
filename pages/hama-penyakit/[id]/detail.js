      ...
      <div className="px-10 pb-6 mx-auto">
        <div className="max-w-6xl px-10 mx-auto">
          ...
          <div className="flex justify-center">
            ...
            >
              <img
                className="object-cover w-full shadow-sm h-full rounded-3xl"
                src={
                  oneData?.foto
          ...
          <div className="max-w-4xl px-10  mx-auto text-2xl text-slate-700 mt-4 rounded-lg bg-slate-100">
            <div>
              <p className="mt-2 p-8 text-justify">{oneData?.deskripsi}</p>
            </div>
          </div>
        </div>
        <Footer auth={false} />
