      ...
      <Content>
        {payload?.processData[0]?.similarity < 0.5 ? (
          <div className="flex flex-col justify-center items-center">
            ...
            />
            <p className="font-bold text-transparent bg-gradient-cyan bg-clip-text my-4 text-center mx-[140px]">
              Oops, gejala yang dipilih tidak didapati kemiripannya terhadap
              basis pengetahuan maka sistem pakar akan memperbaiki/mencari hasil
              solusi identifikasi yang tepat, silahkan periksa riwayat
              identifikasi Anda secara berkala!
            </p>
            <button
