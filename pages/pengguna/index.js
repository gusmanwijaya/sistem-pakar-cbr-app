...
import { fetchAllPengguna, setPage } from "../../redux/pengguna/actions";
import { destroy } from "../../services/pengguna";
...
const Pengguna = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Pengguna - Sistem Pakar Identifikasi Tanaman Kakao Menggunakan Metode
          CBR dan KNN
        </title>
      </Head>
      <Content>
          ...
          {allData.length > 0 ? (
            <>
              <div className="flex justify-end items-center px-4 mb-4">
                <button
                  onClick={() => router.replace("/pengguna/tambah")}
                  type="button"
